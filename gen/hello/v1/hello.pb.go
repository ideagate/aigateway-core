...
// SayHelloRequest carries the name of the person to greet.
...
// SayHelloResponse carries the greeting message.
...
const file_hello_v1_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12A\n" +
	"\bSayHello\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponseB9Z7github.com/ideagate/aigateway-core/gen/hello/v1;hellov1b\x06proto3"
